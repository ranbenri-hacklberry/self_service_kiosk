...
import Component from '../../pages/kds/components/HistoryInfoModal';
...
describe('Historyinfomodal Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Historyinfomodal:`);
