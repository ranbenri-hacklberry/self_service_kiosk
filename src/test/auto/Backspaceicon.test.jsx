...
import Component from '../../pages/new-customer-name-collection-screen/components/BackspaceIcon';
...
describe('Backspaceicon Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Backspaceicon:`);
