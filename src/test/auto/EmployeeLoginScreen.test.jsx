...
import Component from '../../pages/employee-login-screen/index';
...
describe('EmployeeLoginScreen Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in EmployeeLoginScreen:`);
