...
import Component from '@/pages/returning-customer-welcome-screen/components/WelcomeHeader';
...
describe('Welcomeheader Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Welcomeheader:`);
