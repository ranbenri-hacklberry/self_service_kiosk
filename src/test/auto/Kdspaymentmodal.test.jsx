...
import Component from '../../pages/kds/components/KDSPaymentModal';
...
describe('Kdspaymentmodal Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Kdspaymentmodal:`);
