...
import Component from '../../pages/data-manager-interface/index';
...
describe('DataManagerInterface Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in DataManagerInterface:`);
