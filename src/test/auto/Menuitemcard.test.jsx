...
import Component from '../../pages/menu-ordering-interface/components/MenuItemCard';
...
describe('Menuitemcard Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Menuitemcard:`);
