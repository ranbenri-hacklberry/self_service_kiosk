...
import Component from '@/pages/super-admin/DatabaseExplorer';
...
describe('Databaseexplorer Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Databaseexplorer:`);
