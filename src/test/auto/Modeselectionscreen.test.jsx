...
import Component from '../../pages/login/ModeSelectionScreen';
...
describe('Modeselectionscreen Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Modeselectionscreen:`);
