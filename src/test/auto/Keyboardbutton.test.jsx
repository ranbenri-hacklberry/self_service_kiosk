...
import Component from '../../pages/new-customer-name-collection-screen/components/KeyboardButton';
...
describe('Keyboardbutton Auto-Generated Tests', () => {
    ...
    it('contains interactive elements', () => {
        ...
        if (buttons.length > 0) {
            console.log(`Found ${buttons.length} buttons in Keyboardbutton:`);
