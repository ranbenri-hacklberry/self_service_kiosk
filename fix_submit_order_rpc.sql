...
BEGIN
    ...
    LOOP
        ...
        -- CRITICAL FIX: Only set fired_at if stage is 1. Stage 2 (Held) should be NULL.
    ...
    -- NOTE: Loyalty is handled by the frontend via addCoffeePurchase/handleLoyaltyAdjustment
    -- DO NOT call handle_loyalty_purchase here to avoid double-counting!
