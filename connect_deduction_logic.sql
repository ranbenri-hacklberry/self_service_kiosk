-- ============================================================
-- 🔌 CONNECT DEDUCTION LOGIC TO SUBMIT_ORDER_V2
-- ============================================================
...
BEGIN
    ...
    IF edit_mode THEN
        v_order_id := order_id;
        -- (Edit mode logic omitted for brevity - inventory adjustment on edit is complex and skipped for Phase 1)
        -- We focus on NEW orders for simple deduction first.
    ...
    -- =========================================================
    -- Only deduct for NEW orders (edit mode logic is too risky for this phase)
