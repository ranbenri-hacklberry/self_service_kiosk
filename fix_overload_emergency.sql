...
-- 1. DROP ALL VERSIONS of the function to clear collision
DROP FUNCTION IF EXISTS public.submit_order_v2(text, text, jsonb, boolean, uuid, text, boolean, boolean, uuid, numeric, boolean, jsonb, numeric, int, boolean);
DROP FUNCTION IF EXISTS public.submit_order_v2(text, text, jsonb, boolean, uuid, text, boolean, boolean, uuid, numeric, boolean, jsonb, numeric, int); -- Old version without is_quick_order

-- 2. RECREATE the correct one cleanly
