...
async function checkSupplierOrdersTable() {
    ...
    if (error) {
        console.log("Table supplier_orders does not exist or error:", error.message);
    } else {
        console.log("Table supplier_orders exists. Sample:", data);
    }
}

checkSupplierOrdersTable();
