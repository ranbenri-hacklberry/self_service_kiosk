-- Create submit_order_v2 in demo schema
CREATE OR REPLACE FUNCTION demo.submit_order_v2(
    ...
    order_id uuid DEFAULT NULL::uuid, 
    original_total numeric DEFAULT NULL::numeric, 
    is_refund boolean DEFAULT false, 
    p_cancelled_items jsonb DEFAULT '[]'::jsonb, 
    p_final_total numeric DEFAULT NULL::numeric, 
    p_original_coffee_count integer DEFAULT NULL::integer
)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
    -- Set search path to demo first
    SET search_path TO demo, public;

    -- DEBUG: Log incoming p_final_total
    RAISE NOTICE 'submit_order_v2 (DEMO): p_final_total received = %', p_final_total;
